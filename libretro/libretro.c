...
void retro_set_environment(retro_environment_t cb)
{
   ...
   struct retro_variable variables[] = {
      {
         "hatari_sdl_analog","Use Analog; OFF|ON",
      },
      { NULL, NULL },
   };
...
void retro_get_system_info(struct retro_system_info *info)
{
	...
	info->library_name = "hatari-sdl";
	info->library_version = "2.1";
...
void retro_init(void)
{
   ...
   sprintf(retro_system_data, "%s%chatari\0",RETRO_DIR,slash);
...
*/
	...
	update_input();
/*
   	if(ConfigureParams.Screen.bAllowOverscan || ConfigureParams.Screen.bShowStatusbar || pauseg==1 )
   	{
   	   width  = retrow;
   	   height = retroh;
   	}
*/
//	video_cb(videoBuffer, width, height, retrow<< 2);
